...
import { HiHomeModern, HiOutlineCalendarDays, HiOutlineCog, HiOutlineCog6Tooth, HiOutlineHome, HiOutlineUser, HiOutlineUsers } from "react-icons/hi2";
      ...
      <NavList>
        <li>
          <StyledNavLink to='/dashboard' >
            <HiOutlineHome /> <span>Home</span>  </StyledNavLink>
        </li>
        <li>
